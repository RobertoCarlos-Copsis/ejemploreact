...
const Step7Dashboard = () => {
    ...
    const pieData = [
        ...
        { name: 'Comisión', value: stats.totalComision, fill: '#f59e0b' },
    ];
                    ...
                    <div className="chart-wrapper">
                        <ResponsiveContainer width="100%" height={250}>
                            <BarChart data={chartData} margin={{ top: 10, right: 10, left: 10, bottom: 0 }}>
                                ...
                                />
                                <Bar dataKey="Prima" fill="#4f46e5" radius={[4, 4, 0, 0]} barSize={40} />
                                <Bar dataKey="Comision" fill="#f59e0b" radius={[4, 4, 0, 0]} barSize={40} />
                            </BarChart>
                        </ResponsiveContainer>
                    </div>
                    <div className="chart-legend">
                        <span className="leg-item"><i className="dot blue"></i> Prima</span>
                        <span className="leg-item"><i className="dot orange"></i> Comisión</span>
                    </div>
                </div>
